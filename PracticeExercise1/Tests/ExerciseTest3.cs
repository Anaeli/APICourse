...
public class ExerciseTest3
{
    ...
    [Fact]
    public void ValidateStudentListEqualStudentList1()
    {
        Assert.Equal(studentList, studentList1);
    }

    [Fact]
    public void ValidateStudentListNotEqualStudentList2()
    {
        Assert.NotEqual(studentList, studentList2);
    }

    [Fact]
    public void ValidateStudentListHasTwoElements()
    {
        Assert.Equal(2, studentList.Count);
    }

    [Fact]
    public void ValidateStudentList3HasUniqueElements()
    {
        Assert.Equal(studentList3.Count, studentList3.Distinct().Count());
    }

    [Fact]
    public void ValidateStudentList3ContainsJuanPerez()
    {
        Assert.Contains(studentList3, student => student.FullName == "Juan Perez");
    }

    [Fact]
    public void ValidateStudentList3Contains25YearsOld()
    {
