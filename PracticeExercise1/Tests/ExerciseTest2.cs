...
public class ExerciseTest2
{
    ...
    [InlineData(41, false)]
    [InlineData(43, true)]
    public void ValidateNumGreaterOrEqualTo42(int num, bool expected)
    {
    ...
    [InlineData(50, false)]
    [InlineData(49, true)]
    public void ValidateNumLessThan50(int num, bool expected)
    {
    ...
    [InlineData(39, false)]
    [InlineData(51, false)]
    public void ValidateNumBetween40And50(int num, bool expected)
    {
    ...
    public void ValidateD1NotEqualD2(int year1, int month1, int day1, int year2, int month2, int day2, bool expected)
    {
    ...
    public void ValidateD1EqualD2With8DaysRange(int year1, int month1, int day1, int year2, int month2, int day2, bool expected)
    {
        DateTime d1 = new DateTime(year1, month1, day1);
        DateTime d2 = new DateTime(year2, month2, day2);
